    ...
    async function initPlayPage() {
        ...
        try {
            ...
            var hint = portablePayload
                ? 'Не удалось открыть игру по ссылке. Возможно, ссылка обрезана при отправке.'
                : (id
                    ? 'Игра не найдена в этом браузере. Опубликуй проект заново — новая ссылка будет работать везде.'
