    ...
    async function initPlayPage() {
        ...
        try {
            ...
            var hint = portablePayload
                ...
                : (id
                    ? 'Игра не найдена в этом браузере. Опубликуй проект заново — новая ссылка с #pgz1= будет работать везде.'
                    : (err.message === 'missing_game'
                        ? 'В ссылке нет данных игры. Открой Studio, нажми «Опубликовать» и скопируй ссылку целиком — в конце должно быть #pgz1=…\n\nНе открывай play.html напрямую без ссылки.'
