                ...
                html    = [
                    '<div class="ace_search right">',
                        ...
                        '<div class="ace_search_form">',
                            '<input class="ace_search_field" placeholder="Найти" spellcheck="false"></input>',
                            '<button type="button" action="findNext" class="ace_searchbtn next"></button>',
                            '<button type="button" action="findPrev" class="ace_searchbtn prev"></button>',
                            '<button type="button" action="findAll" class="ace_searchbtn" title="Alt-Enter">Все</button>',
                        '</div>',
                        '<div class="ace_replace_form">',
                            '<input class="ace_search_field" placeholder="Заменить на" spellcheck="false"></input>',
                            '<button type="button" action="replaceAndFindNext" class="ace_replacebtn">Заменить </button>',
                            '<button type="button" action="replaceAll" class="ace_replacebtn"> Все</button>',
                        '</div>',
                        '<div class="ace_search_options">',
                            '<span action="toggleRegexpMode" class="ace_button" title="Поиск по регулярному выражению">.*</span>',
                            '<span action="toggleCaseSensitive" class="ace_button" title="Учитывать регистр">Aa</span>',
                            '<span action="toggleWholeWords" class="ace_button" title="Слово целиком">\\b</span>',
                        '</div>',
                    '</div>'
                ].join('');
            div.innerHTML = html;
