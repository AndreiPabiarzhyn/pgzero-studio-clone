...
runCode: function(runMode) {
    ...
    function loadImageGlobal(name, filePath) {
        ...
        function readImage(path) {
            return jsfs.read(path).then(data => new Promise((resolve, reject) => {
                const img = new Image();
                img.onload = () => {
        ...
        PythonIDE.editor = CodeMirror(document.getElementById('editor'), {
            ...
            extraKeys: {
                ...
                "Tab": function (cm) {
                    ...
                    if (CodeMirror.hint && CodeMirror.hint.auto) {
                        cm.showHint({ hint: PythonIDE.autoComplete, completeSingle: false });
                    } else {
