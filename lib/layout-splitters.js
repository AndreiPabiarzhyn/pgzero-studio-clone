...
(function () {
    ...
    function readSidebarWidth() {
        var layout = document.getElementById('mainLayout');
        if (!layout) return 380;
        return parseFloat(getComputedStyle(layout).getPropertyValue('--sidebar-width')) || 380;
    }
    ...
    function init() {
        ...
        var sidebarW = parseInt(localStorage[STORAGE.sidebarWidth] || '380', 10);
        if (sidebarW === 320) sidebarW = 380;
