...
var GALLERY_POPOVER_ACTIONS = {
  image: [
    { icon: 'gView', title: 'Посмотреть', onclick: "showSelected('image')" },
    { icon: 'gRename', title: 'Переименовать', onclick: "renameSelected('image')" },
    { icon: 'gDraw', title: 'Нарисовать', onclick: "showEditor('image')" },
    { icon: 'gDelete', title: 'Удалить', onclick: "deleteSelected('image')" }
  ],
  audio: [
    { icon: 'gPlay', id: 'playBtn', title: 'Слушать', onclick: 'togglePlayPause()' },
    { icon: 'gRename', title: 'Переименовать', onclick: "renameSelected('audio')" },
    { icon: 'gDelete', title: 'Удалить', onclick: "deleteSelected('audio')" }
  ],
  music: [
    { icon: 'gPlay', id: 'playMusicBtn', title: 'Слушать', onclick: 'togglePlayPauseMusic()' },
    { icon: 'gRename', title: 'Переименовать', onclick: "renameSelected('music')" },
    { icon: 'gDelete', title: 'Удалить', onclick: "deleteSelected('music')" }
  ]
};
...
function showItemPopover(item, type) {
  ...
  anchor.appendChild(buildItemPopover(type));
}
...
document.addEventListener('click', function(e) {
  if (e.target.closest('.item-actions-popover') || e.target.closest('.controls-bar')) {
    return;
  }
