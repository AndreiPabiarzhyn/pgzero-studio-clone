...
(function () {
    ...
    var SVGS = {
        ...
        download: '<svg class="pz-icon" viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="3" width="16" height="18" rx="2" fill="#14b8a6"/><path d="M12 7v7" stroke="#fff" stroke-width="2.2" stroke-linecap="round"/><path d="M9 11l3 3 3-3" stroke="#fff" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><rect x="8" y="17" width="8" height="2" rx="1" fill="#99f6e4"/></svg>',
