...
(function () {
    ...
    var SVGS = {
        ...
        projects: '<svg class="pz-icon" viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="4" width="5.5" height="5.5" rx="1.5" fill="#7c3aed"/><rect x="9.25" y="4" width="5.5" height="5.5" rx="1.5" fill="#a78bfa"/><rect x="15.5" y="4" width="5.5" height="5.5" rx="1.5" fill="#7c3aed"/><rect x="3" y="11" width="5.5" height="5.5" rx="1.5" fill="#a78bfa"/><rect x="9.25" y="11" width="5.5" height="5.5" rx="1.5" fill="#7c3aed"/><rect x="15.5" y="11" width="5.5" height="5.5" rx="1.5" fill="#a78bfa"/><circle cx="5.75" cy="6.25" r="1" fill="#fff" opacity=".9"/><circle cx="12" cy="13.25" r="1" fill="#fff" opacity=".9"/><path d="M10 19.5h4" stroke="#fbbf24" stroke-width="2.2" stroke-linecap="round"/></svg>',
        ...
        globe: '<svg class="pz-icon" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="10" fill="#0ea5e9"/><ellipse cx="12" cy="12" rx="10" ry="4.2" fill="none" stroke="#bae6fd" stroke-width="1.4"/><path d="M2 12h20" stroke="#bae6fd" stroke-width="1.2"/><path d="M12 2c2.8 3.2 2.8 16.8 0 20M12 2c-2.8 3.2-2.8 16.8 0 20" stroke="#7dd3fc" stroke-width="1.2" fill="none"/><circle cx="9" cy="10" r="2.2" fill="#34d399" opacity=".95"/><circle cx="15.5" cy="14" r="1.6" fill="#34d399" opacity=".85"/><circle cx="13" cy="8" r="1.1" fill="#6ee7b7" opacity=".9"/></svg>',
        ...
        themeDark: '<svg class="pz-icon" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="10" fill="#eef2ff"/><path d="M15.2 5.8a6.5 6.5 0 106.8 10.4A7.5 7.5 0 0115.2 5.8z" fill="#4f46e5"/><circle cx="17.2" cy="8.2" r=".9" fill="#c7d2fe"/><circle cx="19" cy="11.2" r=".55" fill="#c7d2fe" opacity=".75"/></svg>',

        themeLight: '<svg class="pz-icon" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="10" fill="#fff7ed"/><circle cx="12" cy="12" r="5.2" fill="#fbbf24"/><circle cx="12" cy="12" r="3.2" fill="#fde68a"/><path d="M12 4.2v2.1M12 17.7v2.1M5.9 5.9l1.5 1.5M16.6 16.6l1.5 1.5M4.2 12h2.1M17.7 12h2.1M5.9 18.1l1.5-1.5M16.6 7.4l1.5-1.5" stroke="#f97316" stroke-width="1.7" stroke-linecap="round"/></svg>',
        ...
        gLibrary: '<svg class="pz-icon pz-icon-tile" viewBox="0 0 32 32" aria-hidden="true"><rect width="32" height="32" rx="9" fill="#6366f1"/><rect x="8" y="9" width="6" height="14" rx="1.5" fill="#fff"/><rect x="13" y="11" width="6" height="12" rx="1.5" fill="#c7d2fe"/><rect x="18" y="8" width="6" height="15" rx="1.5" fill="#e0e7ff"/><path d="M10 12h2M15 14h2M20 11h2" stroke="#6366f1" stroke-width="1.2" stroke-linecap="round"/></svg>',
    ...
    function libText(key, fallback) {
        if (typeof PGZI18n !== 'undefined' && PGZI18n.uiText) {
            return PGZI18n.uiText(key, null, fallback);
        }
        return fallback;
    }

    function setLibraryPlayButton(btn, isPlaying) {
        if (!btn) return;
        btn.title = isPlaying
            ? libText('assets.stop', 'Остановить')
            : libText('assets.play', 'Послушать');
        btn.setAttribute('aria-label', btn.title);
        btn.classList.toggle('sound-library-play--active', !!isPlaying);
        setButtonIcon(btn, isPlaying ? 'gPause' : 'gPlay', 22);
    }

    window.PZIcon = {
        svg: svg,
        setButtonIcon: setButtonIcon,
        setLibraryPlayButton: setLibraryPlayButton
    };
})();
