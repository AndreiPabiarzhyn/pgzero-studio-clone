...
(function () {
    ...
    window.setupAppModals = function () {
        ...
        bindModal('soundLibraryModal', function () {
            if (typeof closeSoundLibraryModal === 'function') closeSoundLibraryModal();
        });
        bindModal('musicLibraryModal', function () {
            if (typeof closeMusicLibraryModal === 'function') closeMusicLibraryModal();
        });
        ...
        bindModal('gameTemplatesModal', function () {
            if (typeof PGZGameTemplates !== 'undefined') PGZGameTemplates.closeModal();
        });
        bindModal('templateApplyModal', function () {
            if (typeof PGZGameTemplates !== 'undefined') PGZGameTemplates.closeApplyModal();
        });
        ...
        document.addEventListener('keydown', function (e) {
            ...
            else if (open.id === 'soundLibraryModal' && typeof closeSoundLibraryModal === 'function') closeSoundLibraryModal();
            else if (open.id === 'musicLibraryModal' && typeof closeMusicLibraryModal === 'function') closeMusicLibraryModal();
            ...
            else if (open.id === 'gameTemplatesModal' && typeof PGZGameTemplates !== 'undefined') {
                PGZGameTemplates.closeModal();
            }
            else if (open.id === 'templateApplyModal' && typeof PGZGameTemplates !== 'undefined') {
                PGZGameTemplates.closeApplyModal();
            }
        });
    };
})();
